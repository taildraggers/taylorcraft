"""Scrape Taylorcraft listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Taylorcraft Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=taylorcraft&s-original-search=taylorcraft",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=taylorcraft"),
    ("ASO", "https://aso.com/search?q=Taylorcraft"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Taylorcraft Listings</h2>
    <p>View additional Taylorcraft Aircraft listings at these fine sites:</p>
